    ...
    return (
        <li ref={ref} className='my-8 first:mt-0 last:mb-0 w-[60%] mx-auto flex flex-col items-center justify-center'>
            ...
            <motion.div initial={{ y: 50 }} whileInView={{ y: 0 }} transition={{ duration: 0.5, type: 'spring' }}>
                <h3 className='capitalize font-bold text-2xl'>{position}&nbsp;<a className='text-primary dark:text-primaryDark capitalize' target='_blank' href={companyLink}>@{company}</a></h3>
                ...
                <ul className='w-full flex flex-col items-start justify-between ml-4'>
                    {arr.map(element => {
                        return (<Details
                            ...
                            company='Google'
                            companyLink='https://timescatalog.com'
                            time='2022-Present'
